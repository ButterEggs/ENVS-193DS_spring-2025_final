...
AICc(model1,
  ...
  arrange(AICc)
```
The best model, as determined by Akaike’s Information Criterion (AIC), includes season and distance from the forest edge as predictors of Swift Parrot nest box occupancy and had the lowest AIC value of 226.3133.
